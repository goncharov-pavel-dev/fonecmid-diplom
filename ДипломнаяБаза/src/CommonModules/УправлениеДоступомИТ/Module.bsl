...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//++
	//Гончаров П.С. 09.01.2025
	//добавление поставляемых профилей групп доступа Специалист, Менеджер, БухгалтерИТФирмы, КадровикРасчетчик
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "34f92e9c-5713-42d3-bfc9-6beab5abb112";
	...
	ОписаниеПрофиля.Идентификатор = "6f713bac-8505-4bce-81d5-e8c5022c4053";
	...
	ОписаниеПрофиля.Идентификатор = "26d3284a-34b0-43c7-8403-d09787570c62";
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзмененияДенежныхДокументов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_МассовоеДобавлениеИзменениеДокументовРеализации");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "КадровикРасчетчик";
	ОписаниеПрофиля.Идентификатор = "525011de-7ec1-4ecc-a0e4-7683d2d054bf";
	...
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзменениеНСИ");
	ОписаниеПрофиля.Роли.Добавить("ДобавлениеИзмененияДенежныхДокументов");
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовПоЗарплате");
	ОписанияПрофилей.Добавить(ОписаниеПрофиля);
	//-- 
